...
MODELS_DIR = os.path.join(BASE_DIR, "toPickleFiles")

# Load Models
# 1. Email
email_vec = joblib.load(os.path.join(MODELS_DIR, "email_models", "vectorizer_email.pkl"))
email_lr = joblib.load(os.path.join(MODELS_DIR, "email_models", "lr_model_email.pkl"))
email_feature_names = email_vec.get_feature_names_out()

# 2. URL
url_vec = joblib.load(os.path.join(MODELS_DIR, "url_models", "url_vectorizer.pkl"))
url_lr = joblib.load(os.path.join(MODELS_DIR, "url_models", "url_lr_model.pkl"))
url_le = joblib.load(os.path.join(MODELS_DIR, "url_models", "url_label_encoder.pkl"))
url_feature_names = url_vec.get_feature_names_out()

# 3. Prompt
prompt_vec = joblib.load(os.path.join(MODELS_DIR, "prompt_models", "prompt_vectorizer.pkl"))
prompt_lr = joblib.load(os.path.join(MODELS_DIR, "prompt_models", "prompt_lr.pkl"))
prompt_feature_names = prompt_vec.get_feature_names_out()
...
# Mount the frontend directory so it's served at http://127.0.0.1:8000/
FRONTEND_DIR = os.path.join(BASE_DIR, "Website", "Frontend")
...
if __name__ == "__main__":
    ...
    print("🌐 Click here to open the Website: http://127.0.0.1:8000")
    print("="*70 + "\n")
